...
#ifndef MOE_OPTIMAL_LEARNING_CPP_GPP_FINITE_DOMAIN_HPP_
...
class FiniteDomain {
 ...
 public:
  ...
  FiniteDomain() = delete;  // no default ctor; dim = 0 doesn't reallly make sense as a default
...
//  void GetBoundaryPlanes(Plane * restrict planes) const OL_NONNULL_POINTERS;
  ...
  \endrst*/
//  bool CheckPointInside(double const * restrict point) const OL_NONNULL_POINTERS OL_WARN_UNUSED_RESULT;  // MAYBE NOT TO IMPLEMENT
//  bool CheckPointInside(Point const * restrict point) const OL_NONNULL_POINTERS OL_WARN_UNUSED_RESULT;  // MAYBE NOT TO IMPLEMENT
  /*!\rst
...
#endif  // MOE_OPTIMAL_LEARNING_CPP_GPP_FINITE_DOMAIN_HPP_
