...
def multistart_expected_improvement_mcmc_optimization(
    ...
    best_points_to_sample = C_GP.multistart_expected_improvement_mcmc_optimization(
        ...
        ei_optimizer.objective_function._gaussian_process_mcmc._gaussian_process_mcmc,
        ...
        num_to_sample, ei_optimizer.objective_function.num_being_sampled,
        cpp_utils.cppify(numpy.array(ei_optimizer.objective_function._best_so_far_list)),
...
class ExpectedImprovementMCMC(ExpectedImprovementInterface, OptimizableInterface):
    ...
    def evaluate_at_point_list(
        ...
        ei_values_mcmc = C_GP.evaluate_EI_mcmc_at_point_list(
    ...
    def compute_grad_expected_improvement(self, force_monte_carlo=False):
        ...
        """
        grad_ei_mcmc = C_GP.compute_grad_expected_improvement_mcmc(
                self._gaussian_process_mcmc._gaussian_process_mcmc,
                cpp_utils.cppify(self._points_to_sample),
                cpp_utils.cppify(self._points_being_sampled),
                self.num_to_sample,
